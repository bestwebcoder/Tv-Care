 ...
 *
 * Every account's password is set against this one schema: clients registering
 * themselves, invited doctors/staff/admins choosing a password through
 * reset-password, and anyone resetting a forgotten one. Registration used to
 * carry a weaker 6-digit PIN rule of its own; a pet owner's portal shows their
 * pets' medical records, so it now meets the same bar as every other role.
 */
